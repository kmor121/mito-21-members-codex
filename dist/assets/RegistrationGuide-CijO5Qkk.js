import{r as o,j as t}from"./index-JoKfBcDr.js";function a(){const r=window.location.origin.replace("https://","").replace("http://","");o.useEffect(()=>{window.scrollTo(0,0)},[]);const i=`
<!-- HEADER -->
<div class="rg-header">
...
<div class="rg-container">
      ...
      <div class="rg-mockup">
        ...
        <div class="rg-mockup-body" style="text-align: center;">
          <div style="margin-bottom: 20px;">
            <div style="width: 56px; height: 56px; background: var(--rg-primary); border-radius: 14px; display: inline-flex; align-items: center; justify-content: center; color: white; font-size: 24px; font-weight: 800;">21</div>
          </div>
  ...
  <div class="rg-card" style="text-align: center; margin-bottom: 16px;">
    ...
    <a href="/signin" style="display: inline-block; padding: 14px 40px; background: var(--rg-primary); color: white; border-radius: var(--rg-radius-sm); font-size: 15px; font-weight: 700; text-decoration: none;">
      ログイン・新規登録へ
    </a>
  </div>
...
<div class="rg-footer">
  ...
  `;return t.jsxs(t.Fragment,{children:[t.jsx("style",{children:`
      ...
      `}),t.jsx("div",{className:"rg-root",dangerouslySetInnerHTML:{__html:i}})]})}export{a as default};
