      ...
      <div className="nl-edit-grid" style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 340px", minHeight: "calc(100vh - 120px)" }}>
        ...
        <div className="nl-edit-sidebar" style={{
          ...
          <div style={{ marginBottom: 28 }}>
                    ...
                    {selectedMembers.map((m) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          style={{ background: "none", border: "none", cursor: "pointer", padding: 0, color: "var(--color-accent)", display: "flex" }}
                        >
                          <XIcon />
                        </button>
                      </span>
            ...
            {/* Count display */}
            {previewCount !== null && (
              <div style={{ marginTop: 10, fontSize: 14, fontWeight: 700, color: "var(--color-accent)" }}>
                対象: {previewCount}名
              </div>
            )}
          </div>
                ...
                <div style={{ padding: "24px 28px" }}>
                  ...
                  {bodyPreview && (
                    <div style={modalItemStyle}>
                      ...
                      <div style={{ fontSize: 13, color: "var(--color-text-primary)", lineHeight: 1.6 }}>{bodyPreview}</div>
                    </div>
                  )}
        ...
        return (
          <div className="confirm-overlay" onClick={() => { if (!testSending) setShowTestSend(false); }}>
            <div style={{
              ...
              {/* 説明文 */}
              <div style={{ fontSize: 14, color: "var(--color-text-primary)", marginBottom: 20 }}>
                テストメールを1通送信します。
              </div>
