...
export default function Landing() {
  return (
    <section className="landing-page">
      ...
      <div style={{ marginTop: 40, fontSize: 14, color: 'var(--color-text-secondary)' }}>
        <a href="https://mito21.net/" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--color-accent)', textDecoration: 'none', fontWeight: 600 }}>
          水戸21の会 公式サイト
        </a>
      </div>
    </section>
