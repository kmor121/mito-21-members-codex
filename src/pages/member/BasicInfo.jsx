...
export default function BasicInfo() {
  ...
  if (loading) {
    return (
      <section className="admin-shell">
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: isMobile ? 0 : 'var(--space-6)' }}>
  ...
  return (
    <section className="admin-shell">
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: isMobile ? 0 : 'var(--space-6)' }}>
        <div style={{ flex: 'none' }}>
          <h1 style={{ margin: 0, fontSize: isMobile ? 18 : 20, fontWeight: 'var(--font-weight-bold)', color: 'var(--color-text-primary)', letterSpacing: '-0.02em', lineHeight: 1.2 }}>基本情報</h1>
