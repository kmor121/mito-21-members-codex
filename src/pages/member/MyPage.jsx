...
export default function MyPage() {
  ...
  useEffect(() => {
    ...
    apiRequest(`get-my-member-detail?memberId=${encodeURIComponent(memberId)}`)
      .then((result) => {
    ...
    <section className="admin-shell">
      ...
      <div className="admin-grid admin-grid-wide">
        ...
        <section className="card panel-card">
          <div className="card-body stack">
            <div className="panel-heading"><div><h2>自分の情報</h2></div></div>
        ...
        <section className="card panel-card">
          <div className="card-body stack">
            <div className="panel-heading"><div><h2>プロフィール編集</h2></div></div>
